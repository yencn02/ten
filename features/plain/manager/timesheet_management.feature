Feature: Managers manage timesheets
  In order to manage timesheets for my projects
  As a manager
  I should be able to view, edit and delete timesheets by worker and by project
  ...
  Scenario: Navigate by project
    ...
    When I go to the timesheet list project page
  ...
  Scenario: View timesheets by project
    ...
    When I go to the timesheet list project
    And I follow "ten"
